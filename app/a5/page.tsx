...
const reason1Toast = () => {
  addToast({
    title: "Hey!",
    description: "This button does nothing. But you can make it do something!",
    color: "danger",
  });
};
const reason2Toast = () => {
...
export default function A5Page() {
  return (
    <div>
      ...
      <p>Scar from the lion king is my chosen villian</p>
      <Image
        alt="Scar"
      ...
      >
        Scar told Mufasa that he liked Sarabi but then practically the following
        day, Sarabi and Mufasa got together.
      </Button>
      <Image
        alt="Scar"
      ...
      >
        Scar was in line to be king originally since Mufasa is adopted. Mufasa
        only became king since the rest of the animals randomly voted for him.
      </Button>
      <Image
        alt="Scar"
      ...
      >
        Scar&apos;s birth name is Taka, which litterally translates to trash, so
        his parents clearly never liked him.
      </Button>
      <Image
        alt="Scar"
      ...
      >
        Scar gave the Hyenas acces, who were a shunned grouped in the kingdom.
      </Button>
      <Image
        alt="Scar"
